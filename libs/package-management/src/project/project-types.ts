...
export type PackageInfoMap = Record<PackageName, PackageInfo>;
...
} satisfies Record<PackageDependencyType, keyof KnownPackageJson>;

export type KnownPackageJson = OmitIndexSignature<PackageJson>;
